...
A follow-up to my [Raspberry Pi Zero W home server post](/2026/08/29/setting-up-a-raspberry-pi-zero-w-as-a-home-server/), this time putting the camera module to use. 

<figure><img src="{% asset_path pizerow_camv2.webp %}" loading="lazy" decoding="async" /><figcaption></figcaption></figure>
...
```
<figure><img src="{% asset_path pizerowb.webp %}" loading="lazy" decoding="async" /><figcaption></figcaption></figure>
